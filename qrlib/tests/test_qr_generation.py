...
class GeneratePDFTestCase(unittest.TestCase):
    ...
    def qr_image_format(
        ...
        generated_img = generate_qr_file(
            "JUST SOME TEXT",
            qr_format=qr_format,
            style=style,
    ...
    def test_fail_style(self):
        self.assertRaises(StyleMissing, self.qr_image_format, "PNG", style="NONE")

    def test_fail_innereyestyle(self):
        self.assertRaises(
            InnerEyeStyleMissing, self.qr_image_format, "PNG", inner_eye_style="NONE"
        )

    def test_fail_outereyestyle(self):
        self.assertRaises(
            OuterEyeStyleMissing, self.qr_image_format, "PNG", outer_eye_style="NONE"
        )
